...
pub fn bench_solve_mtdf_d13(crit: &mut Criterion) {
    ...
    // crit.bench_function("easy02_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_easy02), 9, FieldType::Computer)));
    // crit.bench_function("endgame01_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_endgame01), 9, FieldType::Computer)));
    crit.bench_function("beginning01_d13_mtdf", |b| b.iter(|| ABSolver::solve_mtdf(&black_box(board_beginning01), 13, FieldType::Computer)));
    // crit.bench_function("beginning01_d13", |b| b.iter(|| ABSolver::solve(&black_box(board_beginning01), 13, FieldType::Computer)));
}
...
pub fn bench_solve_mtdf_d13_guessed(crit: &mut Criterion) {
    ...
    // crit.bench_function("easy02_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_easy02), 9, FieldType::Computer)));
    // crit.bench_function("endgame01_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_endgame01), 9, FieldType::Computer)));
    crit.bench_function("beginning01_d13_mtdf_guessed", |b| b.iter(|| ABSolver::solve_mtdf_guessed(&black_box(board_beginning01), 13, FieldType::Computer, 10)));
    // crit.bench_function("beginning01_d13", |b| b.iter(|| ABSolver::solve(&black_box(board_beginning01), 13, FieldType::Computer)));
}
pub fn bench_solve_mtdf_d15(crit: &mut Criterion) {
    ...
    // crit.bench_function("easy02_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_easy02), 9, FieldType::Computer)));
    // crit.bench_function("endgame01_d9", |b| b.iter(|| ABSolver::solve(&black_box(board_endgame01), 9, FieldType::Computer)));
    crit.bench_function("beginning01_d15_mtdf", |b| b.iter(|| ABSolver::solve(&black_box(board_beginning01), 15, FieldType::Computer)));
    crit.bench_function("beginning01_d15", |b| b.iter(|| ABSolver::solve(&black_box(board_beginning01), 15, FieldType::Computer)));
}
